...
async function getAchievementsTest(sheets, batchStartYears, departmentCodes, fromYear, toYear) {
...
async function main() {
    ...
    const fromYear = 2017;
    const toYear = 2024;
    await getAchievementsTest(sheets, batchStartYears, departmentCodes, fromYear, toYear);
